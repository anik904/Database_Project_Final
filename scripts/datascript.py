...
university1 = University_T(
    universityID='IUB', universityName='Independent University, Bangladesh', universityAddress='Bashundhara, Dhaka')
university1.save()

university2 = University_T(
    universityID='BRAC', universityName='Brac University, Bangladesh', universityAddress='Rampura, Dhaka')
university2.save()
